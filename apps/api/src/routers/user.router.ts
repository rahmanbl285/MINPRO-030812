...
export class UserRouter {
    ...
    private initializeRoutes(): void {
        ...
        this.router.get('/user-profile', this.userMiddleware.verifyToken, this.userController.userProfile)
        ...
        this.router.post('/reset-password', this.userMiddleware.verifyToken, this.userController.resetPassword)
        // this.router.post('/updatePassword', this.userMiddleware.verifyToken, this.userController.updatePassword)
        // this.router.post('/updatePassword', this.userMiddleware.verifyToken, this.userController.updatePassword)
        // this.router.patch('/verify', this.verifyToken.verifyToken, this.userController.userVerify)
