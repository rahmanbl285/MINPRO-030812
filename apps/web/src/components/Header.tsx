            ...
            <div className="flex items-center justify-between h-20">
                ...
                <form className="hidden md:inline w-[50%] px-10 mx-auto">   
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="default-search" className="flex md:flex-shrink-0 md:flex-grow w-full p-4 ps-6 text-sm text-[#4B6587] border border-gray-300 rounded-full bg-putih " placeholder="Search Event" />
                ...
                <div className="hidden md:block pr-4">
                    <div className="flex items-center space-x-8 text-sm text-putih">
                        <Link href={'/'} className="font-bold flex text-nowrap gap-1"><MdDateRange className="inline text-xl"/>BUAT EVENT</Link>
            ...
            <div className="md:hidden p-4">
                <div className="block px-2 pt-2 pb-3 text-sm space-y-2 sm:px-3 font-semibold text-putih bg-[#4B6587]">
                    <div className="flex w-full gap-4 justify-evenly text-center">
                        <Link href={'/'} className="bg-putih text-biru border-[1px] py-2 w-1/2 rounded-lg ">DAFTAR</Link>
                        <Link href={'/'} className="bg-putih text-biru border-[1px] py-2 w-1/2 rounded-lg">MASUK</Link>
                    </div>
                    <div className="pt-5 flex flex-col gap-3">
                        <Link href={'/'} className="block">BUAT EVENT</Link>
